...
export default function ShowRowActions({ id, active }: { id: number; active: boolean }) {
  ...
  async function deleteShow(e: React.MouseEvent) {
    e.preventDefault()
    e.stopPropagation()
    setDeleting(true)
  ...
  return (
    <div className="flex items-center justify-end gap-3">
      ...
      <button
        ...
        disabled={loading}
        title={isActive ? 'Skrýt seriál' : 'Zobrazit seriál'}
